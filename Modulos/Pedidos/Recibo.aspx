...
.fila .val{ text-align:right; word-break:break-word; font-weight:bold; }
...
.prod .pers{ font-size:10pt; padding-left:3mm; font-style:italic; font-weight:bold; }

.tarjeta     { font-size:11pt; border:1px dashed #000; padding:2mm; margin-top:1mm; }
.tarjeta .ded{ font-style:italic; word-break:break-word; font-weight:bold; }
...
.nota { font-size:10pt; padding:2mm; background:#f0f0f0; border-radius:2mm;
        margin-top:1mm; word-break:break-word; font-weight:bold; }

.pagoEst { display:inline-block; padding:0.5mm 2mm;
           border:1px solid #000; font-weight:bold; font-size:9pt; }

.footer { text-align:center; font-size:9pt; margin-top:3mm; font-weight:bold; }
...
<div class="ticket">
    ...
    <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:1mm">
        <span style="font-size:9pt;font-weight:bold;color:#333"><%=LineaPreFecha%></span>
        <%=BloqueSucursalBadge%>
    </div>
    <div style="font-size:9pt;font-weight:bold;color:#333;margin-bottom:3mm"><%=LineaAgente%></div>
